...
public class DTNHost implements Comparable<DTNHost> {
	...
	private Classifier classifierWeka;
	...
	public DTNHost(List<MessageListener> msgLs, List<MovementListener> movLs,
		...
		if (this.router instanceof ClassifierRouter) {
			setClassifierWeka(new Classifier());
			ClassifierRouter tmprouter = (ClassifierRouter) this.router;
			if (tmprouter.isCollecting())
				getClassifierWeka().setFaseToCollect();
			else if (!tmprouter.isCollecting())
				getClassifierWeka().setFaseToTrain();
		}

		if (getClassifierWeka().isTraining()) {
			getClassifierWeka().setFaseToTest();
		}
	...
	public Classifier getClassifierWeka() {
		return classifierWeka;
	}

	public void setClassifierWeka(Classifier classifierWeka) {
		this.classifierWeka = classifierWeka;
	}
