...
public class Message implements Comparable<Message> {
	...
	private double lastTimeSuccessfulSend = 0D;
	private boolean isFirtsSend;
	...
	private int lastLi;
	private List<Integer> pathReport;
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		this.appID = null;
		this.setMetNroNeighbors(0);
		this.pathReport = new ArrayList<Integer>();

		// this.setPathReport(new ArrayList<NodeReport>());
	...
	public void addNodeForReport() {

		// -----------agregado

		this.pathReport.add((Integer) this
				.getProperty(SaWClassifiedRouter.MSG_COUNT_PROPERTY));
	...
	public int getHopReportCount() {
		return this.pathReport.size() - 1;
	}

	public List<Integer> getHopsReport() {
	...
	protected void copyFrom(Message m) {
		...
		// this.pathReport = new ArrayList<NodeReport>(m.pathReport);
		this.timeCreated = m.timeCreated;
		this.responseSize = m.responseSize;
		this.requestMsg = m.requestMsg;
		this.initTtl = m.initTtl;
		this.appID = m.appID;
		this.metNroNeighbors = m.metNroNeighbors;
		this.pathReport = new ArrayList<Integer>(m.pathReport);
		this.setProbability(m.getProbability());
		this.setLastTimeSuccessfulSend(m.lastTimeSuccessfulSend);
	...
	public int getMetNroNeighbors() {
		return metNroNeighbors;
	}

	public void setMetNroNeighbors(int metNroNeighbors) {
		this.metNroNeighbors = metNroNeighbors;
	}
	...
	/*
	 * public void addNodesIdOnPath(DTNHost from2) { this.getPathNodes().add(new
	 * Node(from2));
	 * 
	 * }
	 */
	...
	/*
	 * public void setPathReport(List<NodeReport> pathReport) { this.pathReport
	 * = pathReport; }
	 */
	...
	public double getLastTimeSuccessfulSend() {
		return lastTimeSuccessfulSend;
	}

	public void setLastTimeSuccessfulSend(double lastTimeSuccessfulSend) {
		this.lastTimeSuccessfulSend = lastTimeSuccessfulSend;
	}

	public boolean isFirtsSend() {
		return isFirtsSend;
	}

	public void setFirtsSend(boolean firtsSend) {
		this.isFirtsSend = firtsSend;
	}
	...
	public int getLastSender() {
		return this.path.get(path.size() - 1).getAddress();
	}
	...
	private int getLastLi() {
		return lastLi;
	}

	private void setLastLi(int lastLi) {
		this.lastLi = lastLi;
	}
